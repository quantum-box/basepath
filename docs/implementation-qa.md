...
- One real child-process MCP stdio test: initialization, 34 tools including the retrieval, breakdown and copilot contracts, resources, prompts, proposal-only behavior, rejected unapproved apply and successful human-approved apply.
