...
- One real child-process MCP stdio test: initialization, 32 tools including the retrieval and breakdown contracts, resources, prompts, proposal-only behavior, rejected unapproved apply and successful human-approved apply.
